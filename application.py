    ...
    "credentials": {
        "usernames": {
            "expert1": {
                ...
                # Hash du mot de passe '12345' par exemple
...
# =====================
# Formulaire Login avec labels personnalisés
# =====================
...
# Debug pour vérifier si le login fonctionne
# st.write(login_info)
...
# =====================
if login_info:
    status = login_info.get("authentication_status")
    if status:
